...
<div class="container">
    <h2 class="mb-4">Reddedilen Ödünç Alma Talepleri</h2>
    <table id="table1" class="table table-hover">
        <thead>
            <tr>
                ...
                <th scope="col">Reddedilme Tarihi</th>
        ...
        <tbody>
            @if ($rentals->isEmpty())
                <tr>
                    <td colspan="5">Reddedilen Ödünç Alma talebi bulunamadı.</td>
                </tr>
            @endif
            ...
            @foreach ($rentals as $rental)
                <tr>
                    ...
                    <td>{{ optional($rental->book)->title ?? 'Kitap mevcut değil' }}</td>
