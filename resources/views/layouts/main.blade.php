...
<body class="font-sans antialiased bg-slate-50 text-slate-900 selection:bg-fuchsia-500 selection:text-white flex flex-col min-h-screen">
            ...
            <div class="flex justify-between h-20">
                ...
                <div class="flex items-center gap-10">
                    ...
                    <a href="/" class="flex items-center gap-2 group">
                        ...
                        <span class="text-2xl font-bold text-slate-900 tracking-tight">BOOKA</span>
                    </a>
                            ...
                            <div x-show="open" 
                                ...
                                <div class="max-h-96 overflow-y-auto">
                                    @forelse(auth()->user()->notifications()->latest()->take(5)->get() as $notification)
                                        <a href="{{ $notification->data['url'] ?? '#' }}" class="block px-4 py-3 hover:bg-indigo-50 transition-colors border-b border-slate-50 last:border-0 group {{ $notification->read_at ? 'opacity-75' : 'bg-indigo-50/30' }}">
                                                ...
                                                <div>
                                                    ...
                                                    <p class="text-xs text-slate-400 mt-1 flex items-center gap-1">
                                                        ...
                                                        @if(!$notification->read_at)
                                                            <span class="w-1.5 h-1.5 bg-rose-500 rounded-full inline-block ml-1"></span>
                                                        @endif
                                                    </p>
                                                </div>
                                            </div>
    ...
    <footer class="bg-white border-t border-slate-200 mt-auto">
        <div class="max-w-7xl mx-auto px-4 py-8 sm:px-6 lg:px-8 flex flex-col md:flex-row justify-between items-center gap-4">
            <p class="text-slate-500 text-sm">© {{ date('Y') }} BOOKA Library System. Tüm hakları saklıdır.</p>
